 ...
 * Produces a single data object for agent synthesis.
 *
...
function collect(cwd, options = {}) {
  ...
  // Normal: add CLAUDE.md, CI, repo-intel, contributor signals, issues
...
function getRepoIntel(cwd) {
  try {
    ...
    if (!fs.existsSync(mapFile)) {
      ...
      JSON.parse(output); // validate before persisting
